...
const PeluqueriaPage: React.FC = () => {
  ...
  const { data: products, isLoading } = useProducts('Peluquer');
        ...
        <section className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h1 className="font-playfair text-3xl md:text-4xl font-medium text-gray-800 mb-4">Delantales para Peluquería</h1>
              <p className="text-gray-600 max-w-2xl mx-auto">
                Delantales profesionales diseñados específicamente para estilistas y peluqueros. Con materiales impermeables 
                y resistentes a productos químicos para proteger su ropa mientras trabaja.
              </p>
            </div>
